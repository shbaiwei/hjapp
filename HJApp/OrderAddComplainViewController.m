...
-(void) submitTouched : (UIButton *) sender{
    ...
    [dict0 setValue:[NSString stringWithFormat:@"%ld",self.selectedType] forKey:@"complain_type"];
...
-(void)loadPhotoView{
    ...
    NSLog(@"photoDataArray count: %ld", [self.photoDataArray count]);
